...
function Form(props) {
  ...
  return (
    <div>
        ...
        <Paper style={{display:"flex" ,margin:"10px auto",padding:"20px 15px",width: 700,height: 30, flexWrap:"wrap"}}>
            <Button style={{marginTop:"0px", marginLeft:"5px", height:"100%"}} onClick={()=>{navigate("/")}}>Back</Button>
            <Button variant="contained" style={{ marginTop:"0px",marginLeft:"10px", height:"100%"}} onClick={handleChange}> Confirm Purchase</Button>
            <Button variant="contained" style={{ marginTop:"0px",marginLeft:"100px", height:"100%"}} onClick={handlePassenger}>{passengerButton}</Button>
            <p style={{ marginTop:"0px",marginLeft:"80px", height:"100%"}}>Price: {finalPrice}</p>
            
        </Paper>
        <Passenger text="Passenger 1" functn={handleChangeAge1} functn2={handleChangeName}></Passenger>
        {
          extraPassenger?<Passenger text="Passenger 2" functn={handleChangeAge2}></Passenger>:null
        }
