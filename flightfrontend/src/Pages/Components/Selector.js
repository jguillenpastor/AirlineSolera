...
import SelectWayofTrip from "./Selectors/SelectWayofTrip";
    ...
    <div className="container">
      <div>
        ...
        <div className="selectores">
          <div className="dcha">
                      <SelectorPlaces style={{marginleft:"10px",padding:"20px 15px",textAlign:"center"}}
            className="dcha"
            funct={handleChange}
            value={location}
          ></SelectorPlaces>
        ...
        <div className="selectores">
          ...
          <BasicDatePicker className="dcha" text="Return date"></BasicDatePicker>
        </div>
        <div>
        <Button variant="contained" onClick={() => {
              navigate("/userform");
            }} style={{marginTop:"20px",textAlign:"center"}}>Confirm</Button>
